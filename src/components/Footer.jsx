        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center">
              <ComputerDesktopIcon className="h-7 w-7 text-blue-600 dark:text-blue-400" />
              <span className="ml-2 text-xl font-bold text-gray-900 dark:text-white">TechHaven</span>
            </Link>
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
              Your one-stop destination for custom PC builds and quality computer parts.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/parts" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  PC Parts
                </Link>
              </li>
              <li>
                <Link to="/custom-pc" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Custom PCs
                </Link>
              </li>
              <li>
                <Link to="/custom-build" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Build Your PC
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="mt-4 md:mt-0 text-center text-sm text-gray-500 dark:text-gray-400">
              &copy; {currentYear} TechHaven. All rights reserved.
            </p>
          </div>
        </div>
      </div>
